...
// verse's own error and missing-dependency alerts are the one exception -
...
Scope {
    ...
    LazyLoader {
        ...
        NotificationServer {
            ...
            onNotification: n => {
                n.tracked = true;
                // notifications verse replay fires itself must not become
    ...
    LazyLoader {
        ...
        PanelWindow {
            ...
            WlrLayershell.namespace: "verse-notifications"
            ...
            // against above). verse's own error/dependency alerts get a unique
            ...
            function snapshot(n) {
                ...
                // (verse-sent) alerts never carry a real app icon - those
