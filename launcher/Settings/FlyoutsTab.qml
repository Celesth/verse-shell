...
// Flyouts: the volume and notification OSDs, plus which alerts verse is
...
Column {
    ...
    // verse's own notify-send calls (missing tools, failed
    ...
    SettingRow { key: "replayCount"; label: "Replay count"; hint: "how many recent notifications `verse replay` can step back through"; valueWidth: Metrics.shortValueWidth }
}
