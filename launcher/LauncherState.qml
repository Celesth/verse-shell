...
Singleton {
    ...
    // The names `verse toggle` takes for the two built-in panes whose
    ...
    // `verse toggle <page>` accepts a custom page's bare filename (what
    // `verse help` lists, e.g. "counter") as well as its real, prefixed
