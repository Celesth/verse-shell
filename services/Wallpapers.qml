...
// The wallpaper folder, the caches verse generates beside it, and the
                            ...
                            if [ "$isvid" = "1" ]; then
                                if ! command -v ffmpeg >/dev/null 2>&1; then
                                    if [ "$warnedFfmpeg" = "0" ] && [ "$alerts" = "1" ]; then
                                        warnedFfmpeg=1
                                        notify-send -a verse -i system-software-install "ffmpeg not found" "ffmpeg is used to generate video wallpaper thumbnails and blurred previews - install it for sharper, faster previews."
                                    fi
                                else
                                ...
                                if [ "$warnedMagick" = "0" ] && [ "$alerts" = "1" ]; then
                                    warnedMagick=1
                                    notify-send -a verse -i system-software-install "magick not found" "ImageMagick is used to generate wallpaper thumbnails and blurred previews - install it for sharper, faster previews."
                                fi
                            else
